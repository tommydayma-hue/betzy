...
const testimonials = [
  {
    name: "Rahul S.",
    role: "Pro Bettor",
    content: "BetZone has completely changed how I bet. The instant payouts and live odds are incredible. Won ₹50k last month!",
    rating: 5,
    avatar: "RS",
  },
  {
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Join thousands of satisfied bettors who trust BetZone
          </p>
        </motion.div>
